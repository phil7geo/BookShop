...
public class ViewBookServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            out.println("<h1 style='text-align: center; color:coral; font-size: 35px;'>Books List</h1>");
...
//            out.print("<tr><th>Id</th><th>Title</th><th>Author</th><th>Price</th><th>Publisher</th><th>Quantity</th><th>Edit</th><th>Delete</th><th>0rder</th></tr>"); 
            out.print("<tr><th>Id</th><th>Title</th><th>Informations</th><th>Edit</th><th>Delete</th><th>0rder</th></tr>");  

            for(Book e:list){  
             out.print("<tr><td>"
                     + e.getId() + "</td><td>"
                     + e.getTitle() + "</th><td><a href='ViewInfoBookServlet?id="
                     + e.getId() + "' style='color: black; font-size: 20px;' >informations</a></td><td><a href='UpdateBookServlet?id="
